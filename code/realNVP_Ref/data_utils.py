...
def load(dataset):
    ...
    """
    assert dataset == 'celeba'   # 3 x 218 x 178
    ...
    transform = transforms.Compose(
        [CelebACrop,
         ...
         transforms.ToTensor()])
    train_set = datasets.ImageFolder("~/vision_datasets/celebA",
        transform=transform)
    [train_split, val_split] = data.random_split(train_set, [190000, 12599])
