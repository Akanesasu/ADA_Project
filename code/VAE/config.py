...
class config(object):
	...
	manualSeed = 1234567 		# random seed for reproducibility
	version = 2.1  			# version
	...
	num_epochs = 3  		# number of training epochs to run
	...
	KL_weight_recover = 5000 # iters needed for recovering; KL cost annealing
